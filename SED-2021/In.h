...
#define IN_CODE_TABLE {\
	...
	struct IN
	{
		//T Ц разрешЄнный символ, F Ц запрещЄнный символ, S Ц сепаратор, V Ц арифметический символ,
		//Q Ц символ ограничивающий литерал, B Ц блокообразующие символы, E Ц символ конца файла.
